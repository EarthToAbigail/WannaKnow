...
def proc_row(window, proc, col_2, col_3, col_4, idx, color):
    ...
    if 'apple' in proc[idx]['name']:
        ...
        raise ValueError('Terminal window too small.\n')
...
def usr_row(window, usr, col_2, col_3, col_4, col_5, color1, color2):
    try:
        ...
        raise ValueError('Terminal window too small to display user informations.\n')
...
def pck_row(window, interface, col_2, idx, color1, color2):
    try:
        ...
        raise ValueError('Terminal window too small to display packets information.\n')
